...
class Student:
    def __init__(self,root):
        ...
        img=Image.open(r"D:\python project\college-images\college_images\face-recognition.png")
        ...
        # 2nd image
        img1=Image.open(r"D:\python project\college-images\college_images\smart-attendance.jpg")
        ...
        #3rd image
        img2=Image.open(r"D:\python project\college-images\college_images\clg.jpg")
        ...
        dep_combo["values"]=("Select Department","computer","IT","Electrical","Mechanical")
        dep_combo.current(0)
        ...
        img_right=Image.open(r"D:\python project\college-images\college_images\student.jpg")
        ...
        search_label=Label(Search_frame,text="Search By:",font=("times new roman",15,"bold"),bg="orange",fg="white")
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","div","roll no","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                conn=mysql.connector.connect(host="localhost",username="root",password="Vishal@2003",database="face_recognizer")
            ...
            try:
                ...
                if update>0:
                   ...
                   my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
                    ...
                    if not update:
                        return
                messagebox.showinfo("Success","Student deatails successfully update completed",parent=self.root)    
                conn.commit()
                self.fetch_data()
                conn.close ()                                                                                                 
            except Exception as  es:
    ...
    def reset_data(self):
        ...
        self.var_roll.set("Select course")
